    ...
    alert("Empty string provided to search");
      ...
      var additionalParams = {
          headers: {
              ...
              'X-Api-Key': 'v5bSgyUsP18VRogxP9Uuy6yc4CO9Bk9t3gBW0kN7'
          }
      }
      var body = {};
...
function uploadImage2(event) {
    ...
    let config = {
        headers: { 'Content-Type': files.type, "X-Api-Key": "v5bSgyUsP18VRogxP9Uuy6yc4CO9Bk9t3gBW0kN7"}
    };

    url = 'https://8a6sl5ujl1.execute-api.us-east-1.amazonaws.com/firstTest/upload/6998hw2-photo-bucket/' + fileName;
