...
def lambda_handler(event, context):
    ...
    # create SQS client
    sqs = boto3.client('sqs', aws_access_key_id="AKIATZIFQLGQELDH7QUD",
                       aws_secret_access_key="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", region_name=region)

    queue_url = 'https://sqs.us-east-1.amazonaws.com/260393949600/slotsQueue'
    ...
    region = 'us-east-1'
    service = 'es'
    auth = ("cloudcomputing", "CloudComputing1!")
    host = 'https://search-restaurants-37xw33ate7okm4hopfywern4dq.us-east-1.es.amazonaws.com'
    index = "restaurants"
    ...
    db = boto3.resource('dynamodb', aws_access_key_id="AKIATZIFQLGQELDH7QUD",
                        aws_secret_access_key="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", region_name=region)
    ...
    ses = boto3.client('ses', aws_access_key_id="AKIATZIFQLGQELDH7QUD",
                       aws_secret_access_key="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", region_name=region)
    html = """<html>
        <head> </head>
        <body>
